...
We'll add another HTTP action that will call the [generateImages](../api/image_generation/V2/) API. This API call requires a few parameters, including the prompt and number of desired images if you want more than one. 
