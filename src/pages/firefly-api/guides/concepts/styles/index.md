...
Here is an array of objects with preset and preset_ID to match the table above:
```javascript
[
  { preset: "Photo", preset_id: "photo" },
  { preset: "Art", preset_id: "art" },
  { preset: "Graphic", preset_id: "graphic" },
  { preset: "Black and white", preset_id: "bw" },
  { preset: "Cool tone", preset_id: "cool_colors" },
  { preset: "Golden", preset_id: "golden" },
  { preset: "Monochromatic", preset_id: "monochromatic" },
  { preset: "Muted color", preset_id: "muted_color" },
  { preset: "Pastel color", preset_id: "pastel_color" },
  { preset: "Toned image", preset_id: "toned_image" },
  { preset: "Vibrant colors", preset_id: "vibrant_colors" },
  { preset: "Warm tone", preset_id: "warm_tone" },
  { preset: "Closeup", preset_id: "closeup" },
  { preset: "Knolling", preset_id: "knolling" },
  { preset: "Landscape photography", preset_id: "landscape_photography" },
  { preset: "Macrophotography", preset_id: "macrophotography" },
  { preset: "Photographed through window", preset_id: "photographed_through_window" },
  { preset: "Shallow depth of field", preset_id: "shallow_depth_of_field" },
  { preset: "Shot from above", preset_id: "shot_from_above" },
  { preset: "Shot from below", preset_id: "shot_from_below" },
  { preset: "Surface detail", preset_id: "surface_detail" },
  { preset: "Wide angle", preset_id: "wide_angle" },
  { preset: "Beautiful", preset_id: "beautiful" },
  { preset: "Bohemian", preset_id: "bohemian" },
  { preset: "Chaotic", preset_id: "chaotic" },
  { preset: "Dais", preset_id: "dais" },
  { preset: "Divine", preset_id: "divine" },
  { preset: "Eclectic", preset_id: "eclectic" },
  { preset: "Futuristic", preset_id: "futuristic" },
  { preset: "Kitschy", preset_id: "kitschy" },
  { preset: "Nostalgic", preset_id: "nostalgic" },
  { preset: "Simple", preset_id: "simple" },
  { preset: "Antique photo", preset_id: "antique_photo" },
  { preset: "Bioluminescent", preset_id: "bioluminescent" },
  { preset: "Bokeh effect", preset_id: "bokeh" },
  { preset: "Color explosion", preset_id: "color_explosion" },
  { preset: "Dark", preset_id: "dark" },
  { preset: "Faded image", preset_id: "faded_image" },
  { preset: "Fisheye", preset_id: "fisheye" },
  { preset: "Gomori photography", preset_id: "gomori_photography" },
  { preset: "Grainy film", preset_id: "grainy_film" },
  { preset: "Iridescent", preset_id: "iridescent" },
  { preset: "Isometric", preset_id: "isometric" },
  { preset: "Misty", preset_id: "misty" },
  { preset: "Neon", preset_id: "neon" },
  { preset: "Otherworldly depiction", preset_id: "otherworldly_depiction" },
  { preset: "Ultraviolet", preset_id: "ultraviolet" },
  { preset: "Underwater", preset_id: "underwater" },
  { preset: "Backlighting", preset_id: "backlighting" },
  { preset: "Dramatic light", preset_id: "dramatic_light" },
  { preset: "Golden hour", preset_id: "golden_hour" },
  { preset: "Harsh light", preset_id: "harsh_light" },
  { preset: "Long-time exposure", preset_id: "long-time_exposure" },
  { preset: "Low lighting", preset_id: "low_lighting" },
  { preset: "Multiexposure", preset_id: "multiexposure" },
  { preset: "Studio light", preset_id: "studio_light" },
  { preset: "Surreal lighting", preset_id: "surreal_lighting" },
  { preset: "3d patterns", preset_id: "3d_patterns" },
  { preset: "Charcoal", preset_id: "charcoal" },
  { preset: "Claymation", preset_id: "claymation" },
  { preset: "Fabric", preset_id: "fabric" },
  { preset: "Fur", preset_id: "fur" },
  { preset: "Guilloche patterns", preset_id: "guilloche_patterns" },
  { preset: "Layered paper", preset_id: "layered_paper" },
  { preset: "Marble", preset_id: "marble_sculpture" },
  { preset: "Made of metal", preset_id: "made_of_metal" },
  { preset: "Origami", preset_id: "origami" },
  { preset: "Paper mache", preset_id: "paper_mache" },
  { preset: "Polka-dot pattern", preset_id: "polka-dot_pattern" },
  { preset: "Strange patterns", preset_id: "strange_patterns" },
  { preset: "Wood carving", preset_id: "wood_carving" },
  { preset: "Yarn", preset_id: "yarn" },
  { preset: "Art deco", preset_id: "art_deco" },
  { preset: "Art nouveau", preset_id: "art_nouveau" },
  { preset: "Baroque", preset_id: "baroque" },
  { preset: "Bauhaus", preset_id: "bauhaus" },
  { preset: "Constructivism", preset_id: "constructivism" },
  { preset: "Cubism", preset_id: "cubism" },
  { preset: "Cyberpunk", preset_id: "cyberpunk" },
  { preset: "Fantasy", preset_id: "fantasy" },
  { preset: "Fauvism", preset_id: "fauvism" },
  { preset: "Film noir", preset_id: "film_noir" },
  { preset: "Glitch art", preset_id: "glitch_art" },
  { preset: "Impressionism", preset_id: "impressionism" },
  { preset: "Industrial", preset_id: "industrialism" },
  { preset: "Maximalism", preset_id: "maximalism" },
  { preset: "Minimalism", preset_id: "minimalism" },
  { preset: "Modern art", preset_id: "modern_art" },
  { preset: "Modernism", preset_id: "modernism" },
  { preset: "Neo-expressionism", preset_id: "neo-expressionism" },
  { preset: "Pointillism", preset_id: "pointillism" },
  { preset: "Psychedelic", preset_id: "psychedelic" },
  { preset: "Science fiction", preset_id: "science_fiction" },
  { preset: "Steampunk", preset_id: "steampunk" },
  { preset: "Surrealism", preset_id: "surrealism" },
  { preset: "Synthetism", preset_id: "synthetism" },
  { preset: "Synthwave", preset_id: "synthwave" },
  { preset: "Vaporwave", preset_id: "vaporwave" },
  { preset: "Acrylic paint", preset_id: "acrylic_paint" },
  { preset: "Bold lines", preset_id: "bold_lines" },
  { preset: "Chiaroscuro", preset_id: "chiaroscuro" },
  { preset: "Color shift art", preset_id: "color_shift_art" },
  { preset: "Daguerreotype", preset_id: "daguerreotype" },
  { preset: "Digital fractal", preset_id: "digital_fractal" },
  { preset: "Doodle drawing", preset_id: "doodle_drawing" },
  { preset: "Double exposure portrait", preset_id: "double_exposure_portrait" },
  { preset: "Fresco", preset_id: "fresco" },
  { preset: "Geometric pen", preset_id: "geometric_pen" },
  { preset: "Halftone", preset_id: "halftone" },
  { preset: "Ink", preset_id: "ink" },
  { preset: "Light painting", preset_id: "light_painting" },
  { preset: "Line drawing", preset_id: "line_drawing" },
  { preset: "Linocut", preset_id: "linocut" },
  { preset: "Oil paint", preset_id: "oil_paint" },
  { preset: "Paint splattering", preset_id: "paint_spattering" },
  { preset: "Painting", preset_id: "painting" },
  { preset: "Palette knife", preset_id: "palette_knife" },
  { preset: "Photo manipulation", preset_id: "photo_manipulation" },
  { preset: "Scribble texture", preset_id: "scribble_texture" },
  { preset: "Sketch", preset_id: "sketch" },
  { preset: "Splattering", preset_id: "splattering" },
  { preset: "Stippling", preset_id: "stippling_drawing" },
  { preset: "Watercolor", preset_id: "watercolor" },
  { preset: "3d", preset_id: "3d" },
  { preset: "Anime", preset_id: "anime" },
  { preset: "Cartoon", preset_id: "cartoon" },
  { preset: "Cinematic", preset_id: "cinematic" },
  { preset: "Comic book", preset_id: "comic_book" },
  { preset: "Concept art", preset_id: "concept_art" },
  { preset: "Cyber matrix", preset_id: "cyber_matrix" },
  { preset: "Digital art", preset_id: "digital_art" },
  { preset: "Flat design", preset_id: "flat_design" },
  { preset: "Geometric", preset_id: "geometric" },
  { preset: "Glassmorphism", preset_id: "glassmorphism" },
  { preset: "Glitch graphic", preset_id: "glitch_graphic" },
  { preset: "Graffiti", preset_id: "graffiti" },
  { preset: "Hyper realistic", preset_id: "hyper_realistic" },
  { preset: "Interior design", preset_id: "interior_design" },
  { preset: "Line gradient", preset_id: "line_gradient" },
  { preset: "Low poly", preset_id: "low_poly" },
  { preset: "Newspaper collage", preset_id: "newspaper_collage" },
  { preset: "Optical illusion", preset_id: "optical_illusion" },
  { preset: "Pattern pixel", preset_id: "pattern_pixel" },
  { preset: "Pixel art", preset_id: "pixel_art" },
  { preset: "Pop art", preset_id: "pop_art" },
  { preset: "Product photo", preset_id: "product_photo" },
  { preset: "Psychedelic background", preset_id: "psychedelic_background" },
  { preset: "Psychedelic wonderland", preset_id: "psychedelic_wonderland" },
  { preset: "Scandinavian", preset_id: "scandinavian" },
  { preset: "Splash images", preset_id: "splash_images" },
  { preset: "Stamp", preset_id: "stamp" },
  { preset: "Trompe l'oeil", preset_id: "trompe_loeil" },
  { preset: "Vector look", preset_id: "vector_look" },
  { preset: "Wireframe", preset_id: "wireframe" },
  { preset: "Authentication", preset_id: "" },
]
```
